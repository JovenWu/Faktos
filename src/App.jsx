    ...
    <div className="snap-y snap-mandatory h-screen overflow-y-scroll">
      ...
      <div className="w-full h-screen snap-start relative">
        ...
        >
          ...
          <EffectComposer
            multisampling={windowSize.width < 768 ? 0 : 4}
...
>
  ...
  >
    ...
    {/* Responsive grid for fact cards */}
    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-20 md:mb-16">
